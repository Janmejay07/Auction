    ...
    <div className="flex-1 flex items-center justify-center p-4 sm:p-6 min-h-[calc(100vh-4rem)]">
      <Card variant="glass" className="w-full max-w-md p-8 space-y-6">
        ...
        <div className="text-center space-y-2">
          ...
          <h1 className="text-2xl font-black text-white tracking-tight">Create Manager Account</h1>
          <p className="text-xs text-slate-400">Join real-time auction drafts and bid against fellow managers</p>
        </div>

        {/* Register Form */}
        <form onSubmit={handleSubmit} className="space-y-4">
          <Input
            label="Full Name / Manager Name"
